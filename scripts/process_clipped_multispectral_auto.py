...
# Past runs might leave legacy Sentinel Hub environment variables behind.
...
limit = int(os.environ.get("CLIP_MAX_RECORDS", "10"))
if limit <= 0:
    limit = 10
...
nodata_val = int(os.environ.get("CLIP_NODATA", "0"))
...
if not chosen_time:
    raise SystemExit("Selected scene is missing acquisition datetime")
