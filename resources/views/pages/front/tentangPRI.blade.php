        ...
        <div class="container mx-auto px-4 sm:px-6 lg:px-8">
            ...
            <div class="mb-12 text-center">
                <h1 class="text-foreground mb-4 text-4xl font-bold md:text-5xl">
                    Tentang <span class="text-primary">Photochemical Reflectance Index</span>
                </h1>
                <p class="text-base-content-muted mx-auto max-w-3xl text-xl">
                    Memahami teknologi deteksi stres tanaman melalui indeks reflektansi fotokimia
                </p>
            </div>
            ...
            <div class="mb-8 rounded-xl bg-white p-8 shadow-lg">
                <div class="mb-6 flex items-center">
                    ...
                    <h2 class="text-foreground text-3xl font-bold">Apa itu PRI?</h2>
                </div>
                <div class="grid items-center gap-8 md:grid-cols-2">
                    <div>
                        <p class="text-base-content mb-4 text-lg leading-relaxed">
                            <strong>Photochemical Reflectance Index (PRI)</strong> adalah indeks vegetasi spektral yang dikembangkan untuk mendeteksi perubahan efisiensi fotosintesis pada tanaman. PRI mengukur perubahan dalam pigmen xanthophyll cycle yang terjadi ketika tanaman mengalami stres.
                        </p>
                        <p class="text-base-content text-lg leading-relaxed">
                            Indeks ini sangat sensitif terhadap stres tanaman dan dapat mendeteksi kondisi stres sebelum gejala visual muncul pada daun.
                        </p>
                    ...
                    <div class="from-muted to-secondary/20 rounded-lg bg-gradient-to-r p-6">
                        <h3 class="text-foreground mb-4 text-xl font-semibold">Formula PRI</h3>
                        <div class="border-primary/50 bg-neutral rounded-lg border-2 border-dashed p-4">
                            ...
                            <p class="text-base-content-muted mt-2 text-center text-sm">
                                R<sub>531</sub> = Reflektansi pada 531 nm<br>
                                R<sub>570</sub> = Reflektansi pada 570 nm
                            </p>
                        </div>
                    </div>
                </div>
            ...
            <div class="bg-neutral mb-8 rounded-xl p-8 shadow-lg">
                <div class="mb-6 flex items-center">
                    ...
                    <h2 class="text-foreground text-3xl font-bold">Bagaimana PRI Bekerja?</h2>
                </div>
                <div class="grid gap-6 md:grid-cols-3">
                    <div class="from-primary/10 to-primary/20 rounded-lg bg-gradient-to-b p-6 text-center">
                        ...
                        <h3 class="text-foreground mb-3 text-xl font-semibold">Kondisi Normal</h3>
                    ...
                    <div class="from-warning/10 to-warning/20 rounded-lg bg-gradient-to-b p-6 text-center">
                        ...
                        <h3 class="text-foreground mb-3 text-xl font-semibold">Deteksi Stres</h3>
                        <p class="text-base-content">
                            Ketika tanaman stres, xanthophyll cycle berubah dan mempengaruhi reflektansi cahaya
                        </p>
                    </div>
                    <div class="from-error/10 to-error/20 rounded-lg bg-gradient-to-b p-6 text-center">
                        ...
                        <h3 class="text-foreground mb-3 text-xl font-semibold">Nilai PRI Berubah</h3>
                        <p class="text-base-content">
                            Perubahan nilai PRI mengindikasikan tingkat stres yang dialami tanaman
                        </p>
                    </div>
                </div>
            </div>
            ...
            <div class="bg-neutral mb-8 rounded-xl p-8 shadow-lg">
                <div class="mb-6 flex items-center">
                    ...
                    <h2 class="text-foreground text-3xl font-bold">Aplikasi PRI</h2>
                </div>
                <div class="grid gap-6 md:grid-cols-2 lg:grid-cols-4">
                    <div class="from-primary/20 to-primary/30 rounded-lg bg-gradient-to-br p-6">
                        <h3 class="text-foreground mb-3 text-lg font-semibold">Pertanian Presisi</h3>
                        <p class="text-base-content text-sm">
                            Monitoring kesehatan tanaman untuk optimalisasi hasil panen
                        </p>
                    </div>
                    <div class="from-secondary/20 to-secondary/30 rounded-lg bg-gradient-to-br p-6">
                        <h3 class="text-foreground mb-3 text-lg font-semibold">Manajemen Air</h3>
                        <p class="text-base-content text-sm">
                            Deteksi dini stres kekeringan untuk scheduling irigasi
                        </p>
                    </div>
                    <div class="from-warning/20 to-warning/30 rounded-lg bg-gradient-to-br p-6">
                        <h3 class="text-foreground mb-3 text-lg font-semibold">Penelitian Ekologi</h3>
                        <p class="text-base-content text-sm">
                            Studi dampak perubahan iklim terhadap vegetasi
                        </p>
                    </div>
                    <div class="from-accent/20 to-accent/30 rounded-lg bg-gradient-to-br p-6">
                        <h3 class="text-foreground mb-3 text-lg font-semibold">Kehutanan</h3>
                        <p class="text-base-content text-sm">
                            Monitoring kesehatan hutan dan deteksi penyakit pohon
                        </p>
                    </div>
                </div>
            </div>
            ...
            <div class="bg-neutral mb-8 rounded-xl p-8 shadow-lg">
                <div class="mb-6 flex items-center">
                    ...
                    <h2 class="text-foreground text-3xl font-bold">Keunggulan PRI</h2>
                </div>
                    ...
                    <div>
                        <ul class="space-y-4">
                            <li class="flex items-start">
                                ...
                                <span class="text-base-content"><strong>Deteksi Dini:</strong> Dapat mendeteksi stres sebelum gejala visual muncul</span>
                            </li>
                            <li class="flex items-start">
                                <div class="bg-primary mr-3 mt-2 h-2 w-2 flex-shrink-0 rounded-full"></div>
                                <span class="text-base-content"><strong>Non-destruktif:</strong> Monitoring tanpa merusak atau mengganggu tanaman</span>
                            </li>
                            <li class="flex items-start">
                                <div class="bg-primary mr-3 mt-2 h-2 w-2 flex-shrink-0 rounded-full"></div>
                                <span class="text-base-content"><strong>Cakupan Luas:</strong> Dapat diaplikasikan pada area yang luas menggunakan satelit</span>
                            </li>
                        </ul>
                    </div>
                    <div>
                        <ul class="space-y-4">
                            <li class="flex items-start">
                                <div class="bg-primary mr-3 mt-2 h-2 w-2 flex-shrink-0 rounded-full"></div>
                                <span class="text-base-content"><strong>Real-time:</strong> Monitoring kondisi tanaman secara kontinyu</span>
                            </li>
                            <li class="flex items-start">
                                <div class="bg-primary mr-3 mt-2 h-2 w-2 flex-shrink-0 rounded-full"></div>
                                <span class="text-base-content"><strong>Sensitif:</strong> Sangat responsif terhadap perubahan fisiologis tanaman</span>
                            </li>
                            <li class="flex items-start">
                                <div class="bg-primary mr-3 mt-2 h-2 w-2 flex-shrink-0 rounded-full"></div>
                                <span class="text-base-content"><strong>Akurat:</strong> Memberikan informasi yang presisi tentang kondisi tanaman</span>
                            </li>
                        </ul>
                    </div>
                </div>
            ...
            <div class="from-primary to-secondary text-primary-foreground rounded-xl bg-gradient-to-r p-8 shadow-lg">
                <div class="text-center">
                    <h2 class="mb-4 text-3xl font-bold">PRI dalam PantauTumbuh.id</h2>
                    <p class="mb-6 text-lg opacity-90">
                        Platform kami mengintegrasikan teknologi PRI dengan citra satelit Sentinel-2 dan model deep learning untuk memberikan analisis komprehensif tentang kondisi stres tanaman
                    </p>
