...
<x-app-front-layout>
    <div class="mx-auto max-w-7xl p-4 md:p-8">
        ...
        @if (isset($pricingContext['currency']))
            <div class="bg-info/10 text-info mb-8 rounded-lg p-4 text-center">
                <p class="font-medium">
                    Prices are displayed in {{ $pricingContext['currency'] }} based on our weekly exchange rate update.
                </p>
            </div>
        @endif
